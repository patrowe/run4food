...
public class MenuCardScene extends StandardScene{
    ...
    private ArrayList<String> dishNames, dishCategories, dishCalories, dishPrices;
    ...
    public void setScene(StandardScene standardScene, MasterController masterController){
        ...
        orderController = new OrderController(masterController);
...
/**
        ...
        dishNames = orderController.loadDishNames();
        ...
        dishCalories = orderController.loadDishCalories();
        for(String calories : dishCalories){
            caloriesVBox.getChildren().add(new Label(calories));
        }

        menuCardHBox = new HBox();
        menuCardHBox.getChildren().addAll(nameVBox, caloriesVBox);
